...
def initialize_static_images(parent_widget, assets_path):
    ...
    return {
        # Dropshadows
        'IMG_Dropshadows': create_image(
            parent_widget, os.path.join(assets_path, "Dropshadows.png"), center=gui_constants.IMG_DROPSHADOWS_COORDINATES
        ),

        # Sidebar and Title
        'IMG_Title': create_image(parent_widget, os.path.join(assets_path, "Banner_Title.png"), center=(0, 0)),
        'IMG_Sidebar_Active_Button': create_image(parent_widget, os.path.join(assets_path, "Sidebar_Active_Button.png"), center=gui_constants.IMG_SIDEBAR_ACTIVE_BUTTON),
