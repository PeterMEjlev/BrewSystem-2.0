...
def initialize_static_images(parent_widget):
    ...
    return {
        # Dropshadows
        'IMG_Dropshadows': create_image(parent_widget, "Dropshadows.png", center=constants.IMG_DROPSHADOWS_COORDINATES),
        
        # Sidebar and Title
        'IMG_Title': create_image(parent_widget, "Banner_Title.png", center=(0, 0)),

        # Pots
        'IMG_Pot_BK_Off_Background': create_image(parent_widget, "Pot_Off_Background.png", center=constants.IMG_POT_BK_COORDINATES),
        'IMG_Pot_BK_On_Background': create_image(parent_widget, "Pot_On_Background.png", center=constants.IMG_POT_BK_COORDINATES), # Hidden     
        'IMG_Pot_BK_On_Foreground': create_image(parent_widget, "Pot_On_Foreground.png", center=constants.IMG_POT_BK_COORDINATES), # Hidden 
        'IMG_Pot_BK': create_image(parent_widget, "Pot_Outline.png", center=constants.IMG_POT_BK_COORDINATES),
        
        'IMG_Pot_MLT_Off_Background': create_image(parent_widget, "Pot_Off_Background.png", center=constants.IMG_POT_MLT_COORDINATES),        
        'IMG_Pot_MLT_On_Background': create_image(parent_widget, "Pot_On_Background.png", center=constants.IMG_POT_MLT_COORDINATES), # Hidden     
        'IMG_Pot_MLT_On_Foreground': create_image(parent_widget, "Pot_On_Foreground.png", center=constants.IMG_POT_MLT_COORDINATES), # Hidden 
        'IMG_Pot_MLT': create_image(parent_widget, "Pot_Outline.png", center=constants.IMG_POT_MLT_COORDINATES),
        
        'IMG_Pot_HLT_Off_Background': create_image(parent_widget, "Pot_Off_Background.png", center=constants.IMG_POT_HLT_COORDINATES),  
        'IMG_Pot_HLT_On_Background': create_image(parent_widget, "Pot_On_Background.png", center=constants.IMG_POT_HLT_COORDINATES), # Hidden     
        'IMG_Pot_HLT_On_Foreground': create_image(parent_widget, "Pot_On_Foreground.png", center=constants.IMG_POT_HLT_COORDINATES), # Hidden       
        'IMG_Pot_HLT': create_image(parent_widget, "Pot_Outline.png", center=constants.IMG_POT_HLT_COORDINATES),

        # Pipes and Reg Boxes
        'IMG_Pipes': create_image(parent_widget, "Pipes.png", center=constants.IMG_PIPES_COORDINATES),
        'IMG_Reg_BK': create_image(parent_widget, "Reg_Box.png", center=constants.IMG_REG_BOX_BK_COORDINATES),
        'IMG_Reg_HLT': create_image(parent_widget, "Reg_Box.png", center=constants.IMG_REG_BOX_HLT_COORDINATES),

        # Coil and Heating Elements
        'IMG_Coil': create_image(parent_widget, "Coil.png", center=constants.IMG_COIL_COORDINATES),
        'IMG_Heating_Element_BK': create_image(parent_widget, "Heating_Element.png", center=constants.IMG_HEATING_ELEMENT_BK_COORDINATES),
        ...
        # Selection Text
        'IMG_BK_Selected': create_image(parent_widget, "TXT_BK_Selected.png", center=constants.TXT_BK_SELECTED_COORDINATES),
        'IMG_HLT_Selected': create_image(parent_widget, "TXT_HLT_Selected.png", center=constants.TXT_HLT_SELECTED_COORDINATES),
        'IMG_REGBK_Selected': create_image(parent_widget, "TXT_REG_Selected.png", center=constants.TXT_REGBK_SELECTED_COORDINATES),
        'IMG_REGHLT_Selected': create_image(parent_widget, "TXT_REG_Selected.png", center=constants.TXT_REGHLT_SELECTED_COORDINATES),
        'IMG_P1_Selected': create_image(parent_widget, "TXT_P1_Selected.png", center=constants.TXT_P1_SELECTED_COORDINATES),
        'IMG_P2_Selected': create_image(parent_widget, "TXT_P2_Selected.png", center=constants.TXT_P2_SELECTED_COORDINATES),
...
def initialize_static_text(parent_widget):
    ...
    return {
        ...
        'TXT_P2': create_label(parent_widget, "P2", color='white', size=constants.TXT_SLIDER_VALUE_SIZE, center=constants.TXT_P2_COORDINATES),
