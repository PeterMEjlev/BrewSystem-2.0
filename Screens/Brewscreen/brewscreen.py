...
class FullScreenWindow(QMainWindow):
    ...
    def initalize_timers(self):
        ...
        self.circular_timer_BK = create_circular_timer(60, parent=self.central_widget, bg_color_idle="#00000", bg_opacity_idle=0.1, bg_color_active="#00000", bg_opacity_active=0.1, icon_idle="Icon_Timer_Black.png", icon_opacity_idle=0.1)
