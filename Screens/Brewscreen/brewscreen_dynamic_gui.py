...
def initialize_dynamic_text(parent_widget):
    ...
    return {
        ...
        'TXT_EFFICIENCY_BK': create_label(parent_widget, f"{variables.settings.efficiency_BK}%", color='white', size=constants_gui.TXT_POT_EFFICIENCY_SIZE, center=constants_gui.TXT_EFFICIENCY_BK_COORDINATES, alignment=Qt.AlignCenter),
        ...
        'TXT_EFFICIENCY_HLT': create_label(parent_widget, f"{variables.settings.efficiency_HLT}%", color='white', size=constants_gui.TXT_POT_EFFICIENCY_SIZE, center=constants_gui.TXT_EFFICIENCY_HLT_COORDINATES, alignment=Qt.AlignCenter),
        
        # Reg Temperatures
        'TXT_TEMP_REG_BK': create_label(parent_widget, f"{variables.settings.temp_REG_BK}°", color='white', size=constants_gui.TXT_REG_VALUE_SIZE, center=constants_gui.TXT_REG_BK_VALUE_COORDINATES, alignment=Qt.AlignCenter),
        'TXT_TEMP_REG_HLT': create_label(parent_widget, f"{variables.settings.temp_REG_HLT}°", color='white', size=constants_gui.TXT_REG_VALUE_SIZE, center=constants_gui.TXT_REG_HLT_VALUE_COORDINATES, alignment=Qt.AlignCenter),
    
        # Pump Speeds (PWM)
        'TXT_PUMP_SPEED_P1': create_label(parent_widget, f"{variables.settings.pump_speed_P1}%", color='white', size=constants_gui.TXT_PUMP_SPEED_SIZE, center=constants_gui.TXT_P1_VALUE_COORDINATES, alignment=Qt.AlignCenter),
        'TXT_PUMP_SPEED_P2': create_label(parent_widget, f"{variables.settings.pump_speed_P2}%", color='white', size=constants_gui.TXT_PUMP_SPEED_SIZE, center=constants_gui.TXT_P2_VALUE_COORDINATES, alignment=Qt.AlignCenter),    
    }
