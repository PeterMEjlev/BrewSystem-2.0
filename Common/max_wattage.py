...
def calculate_current_total_power_consumption():
    BK_current_power = (variables.settings.efficiency_BK/100)*BK_MAX_POWER
    HLT_current_power = (variables.settings.efficiency_HLT/100)*HLT_MAX_POWER
...
def calculate_new_total_power_consumption(pot, new_value):
    if pot == "efficiency_BK":
        ...
        HLT_new_power = (variables.settings.efficiency_HLT/100)*HLT_MAX_POWER
    elif pot == "efficiency_HLT":
        BK_new_power = (variables.settings.efficiency_BK/100)*BK_MAX_POWER
...
def calculate_max_new_efficiency(pot):
    if pot == "efficiency_BK":
        HLT_power = (variables.settings.efficiency_HLT/100)*HLT_MAX_POWER
    ...
    if pot == "efficiency_HLT":
        BK_power = (variables.settings.efficiency_BK/100)*BK_MAX_POWER
